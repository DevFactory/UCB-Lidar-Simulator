...
public class Rayleigh extends Function {
    ...
    private double t;//US Standard org.gonzalez.lidar.atmosphere temperature profile
    private double p;//US Standard org.gonzalez.lidar.atmosphere pressure profile
